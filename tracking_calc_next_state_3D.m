function [ x ] = tracking_calc_next_state_3D( flags, last_x, dt, w )
%TRACKING_CALC_NEXT_STATE_3D Calculate next 3D state, given the prvious one, the random
%variables and the time difference
