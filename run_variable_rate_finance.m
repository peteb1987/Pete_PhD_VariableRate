...
[ filt_part_sets ] = vr_filter_finance( flags, params, times, observ );
...
% Calculate jump time kernel density estimate
[smooth_kd_times, smooth_x_jump_kdest, smooth_xdot_jump_kdest] = jump_kernel_est_finance(times(params.K), smooth_part_sets{2}.pts_tau, smooth_part_sets{2}.pts_type);
