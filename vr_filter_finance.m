...
[last_pts_mu, last_pts_P] = initialise_state_finance(flags, params, Np, MNJ, observ);
...
%         end
        ...
        for ch = 1:Ni
            ...
            [tau, type, mu, P ] = sample_next_state_finance( flags, params, last_t, last_tau, last_intmu, last_intP );
            ...
            if tau < t
                ...
                [pred_lhood, pts_intmu(jj,k,:), pts_intP(jj,k,:,:)] = interp_and_lhood_finance(flags, params, last_t, t, mu, P, observ(:,k));
...
%                 assert(all(eig(squeeze(pts_intP(jj,k,:,:)))>=-1E-6))
        ...
        if non_jumping_kids>0
            ...
            [pred_lhood, pts_intmu(jj,k,:), pts_intP(jj,k,:,:)] = interp_and_lhood_finance(flags, params, last_t, t, last_intmu, last_intP, observ(:,k));
