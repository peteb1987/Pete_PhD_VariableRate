...
filename = 'filtsmooth_comparison_results_Nf500_Ns0_100rpts.mat';
...
%     results.smooth_rmse(r) = smooth_rmse;
    ...
    results.filt_ENEES(r,:) = filt_ENEES;
    results.kita_ENEES(r,:) = kita_ENEES;
%     results.smooth_ENEES(r,:) = smooth_ENEES;
...
save(filename, 'flags', 'params', 'times', 'results');
