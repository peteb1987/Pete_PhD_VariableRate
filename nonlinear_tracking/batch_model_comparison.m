...
for r = 1:num_seeds;
    ...
    [ filt_rmse, ~, ~] = filter_errors( flags, params, filt_part_sets, times, true_tau, true_intx );
    [ kita_mNs, ~, kita_rmse, ~, ~] = performance_measures( flags, params, filt_part_sets{end}, times, true_tau, true_intx );
...
save('model_comparison_results.mat', 'results');
