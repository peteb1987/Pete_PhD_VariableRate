...
cp_time = inverse_cdf_gamma_rnd(model.period_trans_shape, model.period_trans_scale, start_time-(pre_cp_time+model.period_trans_shift));
cp_param = tracking_paramtrans(model, []);
cp_state = tracking_evaluatestate(model, [pre_cp_time cp_time], [pre_cp_state cp_state], [pre_cp_param cp_param]);
