...
disp('Counting unique particles...')
...
for k = 1:K
    ...
    for ii = 1:Np
        ...
        w_ii = pts(ii).w(pts(ii).tau<times(k));
...
fprintf(1, 'Found %u unique particles.\n', Nup(end));
