function [state_x, state_tau, y, times, interp_x] = generate_data_finance( params )
...
for k=1:params.K
    ...
    Q = [params.x_sigma^2, 0; 0, params.xdot_sigma^2];
    
    % Sample new state
    state(:,k) = mvnrnd(A*last_state+u, Q);
    
    % Sample observation
    y(1,k) = normrnd(state(1,k), params.obs_sigma);
