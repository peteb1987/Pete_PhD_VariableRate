function [ pt ] = resam_move_tracking( flags, params, k, pt, times, observ, type )
...
switch type
    ...
    case 1
        ...
        [new_lhood, ppsl_intx] = tracking_calc_likelihood(flags, params, last_x, last_tau, w_replace, times(1:k), observ(:,1:k));
